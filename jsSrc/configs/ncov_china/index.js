...
exports.renderResData = exports.getFormatTimeStr = exports.renderNewsCard = exports.renderMarkdownTable = exports.dealWithNumber = exports.joinWithPlus = exports.getApiData = exports.writeMdWithContent = exports.writeZhNcovCategroy = exports.writeFileList = exports.readFileList = exports.ChartList = exports.URL_Object = exports.BaseUrl = exports.BaseApiInfo = exports.jsonFilePath = exports.zhNcovCategroy = exports.base = exports.mdPath = exports.rootPath = void 0;
...
exports.jsonFilePath = exports.rootPath + '/docs/.vuepress/public/json/chinaRoutes.json';
exports.BaseApiInfo = {
...
const writeZhNcovCategroy = (fileList) => {
  ...
  linkList.value = [
    ${`{
      ...
      "children": [${fileList
        .map((x) => {
        return `{"title": "${x.text}","link": ".${x.link.replace('md', 'html')}"},`;
    })
        .join('')}]
    }`}
  ]
...
const renderMarkdownTable = (cityInfo) => {
    return cityInfo
        .map((item) => {
        return `|${item.city}|${(0, exports.joinWithPlus)(item.localAdd)}|${(0, exports.joinWithPlus)(item.asymptomAdd)}|${(0, exports.joinWithPlus)(item.localAddTotal)}|${(0, exports.joinWithPlus)(item.riskLevelNum)}|\n`;
    })
        .join('');
};
...
const renderResData = (params) => {
    const { chinaRealTimeInfo, provinceInfos, cityRes, trendInfoRes, cityTrendRes, contentsRes, trendChartInfoRes } = params;
